...
class CameraViewController: UIViewController, AVCaptureFileOutputRecordingDelegate {
    ...
    func toggleCaptureMode(_ _captureModeControl: UISegmentedControl) {
    ...
    func capture(_ captureOutput: AVCaptureFileOutput!, didFinishRecordingToOutputFileAt outputFileURL: URL!, fromConnections connections: [Any]!, error: Error!) {
        ...
        if error != nil {
            ...
            self.cameraViewControllerDelegate?.videoRecordingFailed()
        }
        
        if success {
            
            self.cameraViewControllerDelegate?.videoRecordingComplete(videoUrl: outputFileURL as NSURL)
